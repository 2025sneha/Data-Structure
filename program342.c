...
void DeleteAtPos(PPNODE first, int pos)
{
    ...
    PNODE temp = NULL;
    PNODE target = NULL;      //target want to delete
...
int main()
{
   ...
   while(1)
   {
        ...
        else if(iChoice == 6)
        {
            ...
            printf("Enter the position from which you want to delete new node : \n");
            scanf("%d",&iPos);
        ...
        {
            printf("Elements of the linedlist are : \n");
            Display(head);
        }
        else if(iChoice == 8)
        {
